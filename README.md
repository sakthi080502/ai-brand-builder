<img width="1344" height="768" alt="brand-billboard" src="https://github.com/user-attachments/assets/7d02221f-8604-49d3-ba9e-0eb40b3269fb" /># ai-brand-builder
An AI‑powered Brand Builder App that transforms a simple product description into a full visual campaign. Generates consistent billboard, newspaper, and social‑media assets using Gemini models, with strict no‑people rules and a detailed visual‑identity pipeline.
...
Overview
The Brand Builder App allows users to describe any product and instantly visualize it across multiple advertising media. The app uses a two‑stage pipeline:
...
<img width="1024" height="1024" alt="brand-social-post" src="https://github.com/user-attachments/assets/9699c008-eaeb-4144-8e5c-311c3f22e9ac" />
